/*
  ...
  - You are about to drop the `_TwitterReply` table. If the table is not empty, all the data it contains will be lost.
...
-- DropForeignKey
ALTER TABLE "_TwitterReply" DROP CONSTRAINT "_TwitterReply_A_fkey";
