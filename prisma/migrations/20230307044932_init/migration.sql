/*
  ...
  - You are about to drop the `_QuestionChoice` table. If the table is not empty, all the data it contains will be lost.
...
-- DropForeignKey
ALTER TABLE "_QuestionChoice" DROP CONSTRAINT "_QuestionChoice_A_fkey";

-- DropForeignKey
ALTER TABLE "_QuestionChoice" DROP CONSTRAINT "_QuestionChoice_B_fkey";
