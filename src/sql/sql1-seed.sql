...
-- การ insert ข้อมูลทีละตัว
INSERT INTO teachers (name, age) VALUES ('Bond', 30);
INSERT INTO public.teachers (name, age) VALUES ('Bond2', 30);


-- การ Insert ตัวข้อมูลเข้าไปข้างในแบบหลาย ๆ ตัว
...
-- อันนี้คือตัว Data insert ตัวเต็มที่เอามาจากอาจารย์ Bin
